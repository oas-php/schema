...
class SchemaTest extends TestCase
{
    ...
    public function itProvidesAccessToGraphNodesUsingPath(): void
    {
        ...
        $this->assertEquals('object', $schema->get('/type'));
        $this->assertEquals('string', $schema->get('/properties/name/type'));
        $this->assertInstanceOf(Schema::class, $schema->get('/properties/name'));
    }
